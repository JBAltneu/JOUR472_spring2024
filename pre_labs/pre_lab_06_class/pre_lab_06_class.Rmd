...
**Task** Load the four CSV population estimate files. Do they have the same column structure? **Answer: Yes, they have the same number of rows and columns. All the column rows are the same.**
...
This code combines all the data in like columns together into one spreadsheet. There is another total column since in the 2022 voting data, the total column is written out like "Total" compared to "TOTAL" like all the others.

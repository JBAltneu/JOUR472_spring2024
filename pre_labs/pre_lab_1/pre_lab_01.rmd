...
**Answer 60,712 observations and 8 variables**
...
In the space below, write the data type for the "id" column and the "seats" column (it's in light gray, offset by \< \>). **Answer: chr for id and dbl or num for seats**
...
**Answer The number of classes offered each semester**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer: Course offerings for fall and spring semester classes were all at the top**
...
**Answer: It lists the number of classes for each department in a specific term.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer: List the number of classes for each term and the number of open seats.**

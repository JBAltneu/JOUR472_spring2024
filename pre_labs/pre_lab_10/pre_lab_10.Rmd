...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer: I see a column for shape length, shape area and geometry as well as a column for each zip code. The geometry column explains how to draw that zip code on a map.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: It creates a map of the state of Maryland with markings for each zip code in the state of Maryland.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: It creates a separate data file for data of just Maryland counties with multi-polygons.**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer: Southern Maryland had the highest rate of foreclosures. Northern Maryland also has a higher rate of foreclosures.**

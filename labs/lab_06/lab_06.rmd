...
A1. Carroll, Cecil and then Allegany.
...
A2. There are more overdose calls when it is warmer outside. August was the worst month for overdose calls in all three counties. There was never a month with less than 17 overdose calls.

314 Grove Neck Road in Cecil County had the most overdose calls with 15.

```{r}
monthly_calls_by_county <-combined_911 |>
...
A3. Zip codes 21201, 21223, and 21217 are the zip codes with the highest rates of overdose calls in areas with a 75% or more population under 18 with 18, 19 and 20 calls respectively per 1,000 people.

In zip code 21217 some of the neighborhoods are Penn North, Harlem Park and Reservoir Hill.
...
I want to explore the number of calls in neighborhoods with white non-hispanic populations over 60%. I also want to know the average age of those neighborhoods.

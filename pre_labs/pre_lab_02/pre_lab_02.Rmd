...
**Answer: We are storing it a new variable so we don't permanently lose the data we get it.**
...
**Answer: The table churned out the date with the year, month and then day separated by hyphens.**
...
**Answer: It calculated the total amount of money spent per month in all the campaigns. June 2022 was the month with the most money spent.**
...
**Answer: It added a new column to the general_22 data sheet with the percent of votes going to Moore.**
...
**Answer: They ordered the counties by which ones had the most voters vote for Moore.**
...
**Answer: It's interesting cause you can see the counties Moore got the least votes.**
...
1.  For the Maryland expenditure data how many people contributed over \$500? (I want to see all the information about everyone who spent over \$500 not just the total number of people.)

2.  For the Maryland expenditure data, what was the most common expense category?

3.  How many people from Maryland donated money that went to media expenses?

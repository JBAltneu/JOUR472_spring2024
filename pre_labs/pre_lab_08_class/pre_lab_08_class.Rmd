...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer: The label = True part of the code gives us a shortened name of the month instead of the number of the month.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: A bar graph appears**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: The graph flipped from vertical to a horizontal bar chart.**
...
**Task** Run the following code. What do you think this does? **Answer: It saved a picture of the graph we created in R to my computer. Way to export ggplots we create in R to specific file name.**

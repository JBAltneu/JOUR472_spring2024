...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer: Slightly positive correlation.**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer: Less of a clear correlation.**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer: Population change and gdp growth has a positive correlation. Population change and per pupil spending has a negative correlation.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: We can trust this negative correlation since the p-value is very low.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: We can not assume the correlation between these two variables since the p-value is high.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: Can't trust this correlation since the p-value is slightly above our threshold. There is not a difference between states that vote for Biden and Trump and their population change in 2021.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: Statistically, Biden voting states spend more money per student**

...
A2: 2020 had the largest total amount. There is no data for 2016, 2021 and 2022.
...
A3. Some vendors with similar names are A&I INC and A&I INC., Amtek Company Inc and Amtek Company, Inc. and Ayers Saint Gross and Ayers Saint Gross Incorporated.

I would use methods like in question 2 so we could test different strings and combine them in one with different variations. But I would combine all combos of companies including ones with letters misspelled.
...
A4: Money for stem cell research has mostly decreased over time and falls somewhere in the 6-8 million dollar range.
